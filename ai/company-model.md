...
| Field        | Type     | Description |
|--------------|----------|-------------|
| brand        | string   | Commercial brand name (e.g. "Mairon") |
| group        | string   | Parent company group (e.g. "Mairon Systems") |
...
- **scraperFile**: Full URL to the GitHub Actions workflow (no raw, e.g. `https://github.com/peviitor-scrapers/mairon-galati-sa-nodejs-scraper/actions/workflows/job-seeker-ro-spider.yml`)