...
```bash
gh issue list --repo peviitor-scrapers/mairon-galati-sa-nodejs-scraper --state open
```
...
- `docs/test-results/index.html` — branding must say "Mairon", not the old template
